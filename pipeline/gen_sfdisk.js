...
// pipeline/manifests/beacon-relay-partition-map.json. Keeps jq-out-of-the-loop in
...
const map = JSON.parse(fs.readFileSync('pipeline/manifests/beacon-relay-partition-map.json', 'utf8'));
