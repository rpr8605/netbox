...
const CACHE_PATH = process.env.BEACON_RELAY_DOWNTIME_CACHE || '/data/downtime_cache.json';
...
export function renderDowntimeHtml(bundle) {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><title>Beacon Relay Downtime Mode</title>
...
<h1>Beacon Relay — Downtime Mode</h1>
