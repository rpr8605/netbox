...
const CRITICAL_SERVICES = ['ehr', 'adt', 'lab', 'pharmacy', 'imaging', 'eprescribe', 'internet', 'phone', 'printing', 'custom', 'cert_expiration', 'firewall', 'dns', 'wan', 'm365_account_health', 'wireless_ap_health', 'vpn_tunnel_health', 'backup_dr_status', 'av_edr_checkin'];
