...
// Database schema definitions for SQLite (local dev/tests) and PostgreSQL
// (production). Kept in one file so the migration script and the runtime driver
// share the same DDL.
...
CREATE TABLE IF NOT EXISTS device_replacements (
  ...
  site_id       TEXT NOT NULL,
  reason        TEXT,
  replaced_at   TEXT NOT NULL DEFAULT NOW()::TEXT,
  PRIMARY KEY (old_device_id, new_device_id)
);
...
export const PG_ALTER_COLUMNS = `
ALTER TABLE events ADD COLUMN IF NOT EXISTS channel_id TEXT;
ALTER TABLE channels ADD COLUMN IF NOT EXISTS site_id TEXT;
ALTER TABLE channels ADD COLUMN IF NOT EXISTS source_system TEXT;
ALTER TABLE channels ADD COLUMN IF NOT EXISTS destination_system TEXT;
ALTER TABLE support_sessions ADD COLUMN IF NOT EXISTS action_id TEXT;
ALTER TABLE devices ADD COLUMN IF NOT EXISTS cert_serial TEXT;
ALTER TABLE devices ADD COLUMN IF NOT EXISTS cert_not_after TEXT;
ALTER TABLE devices ADD COLUMN IF NOT EXISTS device_key_fp TEXT;
`;

export const SQLITE_ALTER_COLUMNS = [
  `ALTER TABLE events ADD COLUMN channel_id TEXT;`,
  `ALTER TABLE channels ADD COLUMN site_id TEXT;`,
  `ALTER TABLE channels ADD COLUMN source_system TEXT;`,
  `ALTER TABLE channels ADD COLUMN destination_system TEXT;`,
  `ALTER TABLE support_sessions ADD COLUMN action_id TEXT;`,
  `ALTER TABLE devices ADD COLUMN cert_serial TEXT;`,
  `ALTER TABLE devices ADD COLUMN cert_not_after TEXT;`,
  `ALTER TABLE devices ADD COLUMN device_key_fp TEXT;`,
];
